...
namespace ItsBaptiste.Toolbox.SceneReference {
    ...
    public class SceneReference : ISerializationCallbackReceiver {
        ...
        private bool IsLevel {
            get { return MtwScenes.SceneIsALevel(ScenePath); }
        }
    ...
    public static class SceneReferenceExtensions {
        public static SceneReference ToSceneReference(this EditorBuildSettingsScene scene) {
            return new SceneReference() { ScenePath = scene.path };
        }
