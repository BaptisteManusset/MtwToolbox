...
namespace ItsBaptiste.Toolbox.Tools.Odin {
    public class OdinWatchWindow : OdinEditorWindow {
        [SerializeField] private List<TreeValuesHolder> _properties = new List<TreeValuesHolder>();
            ...
            for (int i = 0; i < _properties.Count; i++) {
                ...
                if (holder.Tree.UnitySerializedObject?.targetObject == null) {
                    ...
                    for (int index = 0; index < holder.ValuePaths.Count; index++) {
                        ...
                        Rect rect1 = GUILayoutUtility.GetRect(EditorGUIUtility.singleLineHeight + 5, EditorGUIUtility.singleLineHeight + 3, GUILayout.ExpandWidth(false))
        ...
        private class TreeValuesHolder {
            ...
            [NonSerialized] public Object ParentObject;
